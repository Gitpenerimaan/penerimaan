...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/"        class="{{ request()->is('/')?        "bg-gray-600 text-white" :  "text-gray-300 hover:bg-white/5 hover:text-white"  }} "rounded-md px-3 py-2 text-sm font-medium">Dashboard</a>

              <a href="/contact" class="{{ request()->is('contact')? "bg-gray-600 text-white" :  "text-gray-300 hover:bg-white/5 hover:text-white"  }} "rounded-md px-3 py-2 text-sm font-medium">Contact</a>

              <a href="/about"   class="{{ request()->is('about')?  "bg-gray-600 text-white" :  "text-gray-300 hover:bg-white/5 hover:text-white" }}  "rounded-md px-3 py-2 text-sm font-medium">About</a>
  ...
  <header class="relative bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <h1 class="text-4xl font-bold tracking-tight text-gray-900">{{ $heading }}
      </h1>
